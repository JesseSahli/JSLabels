...
//  JSLabels
//
//  Created by JesseSahli on 11/14/2020.
//  Copyright (c) 2020 JesseSahli. All rights reserved.
//
...
class ViewController: UIViewController {
    ...
    let blinkingLabel = BlinkingLabel(frame: CGRect(x: 40, y: 80, width: 200, height: 30))
